 ...
 * @author PC
 */
public class UserFPW extends javax.swing.JFrame {
Connection conn;
ResultSet rs;
PreparedStatement pst;
    /**
     * Creates new form UserFPW
     */
    public UserFPW() {
        initComponents();
...
int xy,xx;
    ...
    private void searchMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_searchMouseClicked
        ...
        String sql = "select * from useracc where username='"+a1+"'";
        try{
    ...
    private void refrechMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_refrechMouseClicked
        ...
        String sql = "select * from useracc where answer='"+a2+"'";
        try{
            pst=conn.prepareStatement(sql);
            rs=pst.executeQuery();
            if (rs.next()){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UserFPW.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
